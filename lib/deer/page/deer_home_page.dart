...
import 'package:hello_flutter/deer/page/order_page.dart';
import 'package:hello_flutter/deer/provider/deer_home_provider.dart';
import 'package:hello_flutter/deer/res/colors.dart';
import 'package:hello_flutter/deer/res/dimens.dart';
import 'package:hello_flutter/deer/util/double_tap_back_exit_app.dart';
...
class DeerHomePage extends StatefulWidget {
  @override
  _DeerHomePageState createState() => _DeerHomePageState();
}

class _DeerHomePageState extends State<DeerHomePage> {
  var _pageList;
      ...
      child: DoubleTapBackExitApp(
        child: Scaffold(
          bottomNavigationBar: Consumer<HomeProvider>(
            builder: ( _context, provider,  widget) {
              return BottomNavigationBar(
                ...
                Colours.dark_unselected_item_color : Colours.unselected_item_color,
