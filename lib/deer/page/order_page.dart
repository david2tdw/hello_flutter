...
import 'package:hello_flutter/deer/widgets/my_flexible_space_bar.dart';
import 'package:hello_flutter/deer/widgets/order_list.dart';
...
class _OrderPageState extends State<OrderPage>
  ...
  OrderPageProvider orderPageProvider = OrderPageProvider();
...
class _TabView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<OrderPageProvider>(
      builder: (_, orderPageProvider, child) {
        int selectIndex = orderPageProvider.index;
        return Stack(
          children: <Widget>[
            Container(
              width: 46.0,
