...
import 'package:hello_flutter/logic/bloc/cart_bloc.dart';
import 'package:hello_flutter/model/product.dart';
import 'package:hello_flutter/ui/widgets/common_divider.dart';
...
class ShoppingAction extends StatefulWidget {
  ...
  @override
  _ShoppingActionState createState() => _ShoppingActionState();
}

class _ShoppingActionState extends State<ShoppingAction> {
  String _value ="Cyan";
  String _sizeValue = "M";
  ...
  Widget colorsCard() => Column(
    ...
    children: <Widget>[
      ...
      Wrap(
        ...
        children: widget.product.colors.map((pc) => Padding(
  ...
  Widget sizedCard() => Column(
    ...
    children: <Widget>[
      ...
      Wrap(
        ...
        children: widget.product.sizes.map((pc) => Padding(
          padding: const EdgeInsets.all(8.0),
          child: ChoiceChip(
