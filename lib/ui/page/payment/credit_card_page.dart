...
import 'package:hello_flutter/logic/bloc/credit_card_bloc.dart';
        ...
        child: Card(
          ...
          child: Stack(
            ...
            children: <Widget>[
              ...
              MediaQuery.of(_context).orientation == Orientation.portrait ? cardEntries(): FittedBox(
                child: cardEntries(),
              ),
              Positioned(
                right: 10.0,
      ...
      children: <Widget>[
        StreamBuilder<String>(
          ...
          builder: (context, snapshot) {
            snapshot.data.length > 0 ? ccMask.updateText(snapshot.data): null;
            return Text(
        ...
        Row(
          ...
          children: <Widget>[
            StreamBuilder<String>(
              ...
              initialData: "MM/YY",
              builder: (context, snapshot) {
                snapshot.data.length > 0 ? expMask.updateText(snapshot.data): null;
                return ProfileTile(
                  textColor: Colors.white,
                  title: "Expiry",
                  subtitle: snapshot.data.length > 0 ? snapshot.data: 'MM/YY',
                );
              },
            ),
            SizedBox(
